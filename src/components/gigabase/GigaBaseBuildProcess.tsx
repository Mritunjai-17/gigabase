    ...
    <section className="w-full relative bg-[#04070f] py-20 md:py-28 px-4 sm:px-6 md:px-12 lg:px-16 border-t border-white/[0.05]">
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="relative mb-8 md:mb-10 px-2 sm:px-4">
          {/* Progress line */}
          <div className="hidden md:block absolute top-1/2 left-8 right-8 h-[1px] -translate-y-1/2 bg-white/[0.08] z-0"></div>
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-xl border transition-all duration-200 cursor-pointer flex flex-col justify-between ${
                    isSelected
                      ? isFinal 
                        ? "bg-[#070c1a] border-[#00e878]/40"
                        : "bg-[#070c1a] border-[#3daeff]/40"
                      : "bg-[#010409]/90 border-white/[0.06] hover:border-white/[0.14] hover:bg-white/[0.015]"
                  }`}
                >
                  <div>
                    {/* Top Row: Stage & Month */}
                  ...
                  <div className="mt-4 pt-3 border-t border-white/[0.05] flex items-center justify-between">
                    ...
                    {isFinal && (
                      <span className="text-[9px] font-mono font-bold text-[#00e878]">
                        ENERGIZED
                      </span>
                    )}
                  </div>
