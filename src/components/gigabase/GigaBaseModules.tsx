    ...
    <section id="modules" className="w-full relative bg-[#04070f] py-20 md:py-28 lg:py-32 px-4 sm:px-6 md:px-12 lg:px-16 border-t border-white/[0.05]">
      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          ...
          {/* Left Column: Interactive Module List */}
              ...
              return (
                <div
                  ...
                  className={`p-5 rounded-xl border transition-all duration-200 cursor-pointer ${
                    isActive
                      ? "bg-[#070c1a] border-[#3daeff]/40"
                      : "bg-[#010409]/60 border-white/[0.06] hover:border-white/[0.14] hover:bg-white/[0.015]"
                  }`}
                >
                  <div className="flex items-center justify-between gap-2 mb-2">
                    <div className="flex items-center gap-2.5">
                      <span className={`text-[12px] font-mono font-bold ${isActive ? "text-[#3daeff]" : "text-white/30"}`}>
                        {mod.number}
                      </span>
                      <h3 className={`text-base sm:text-lg font-bold tracking-tight uppercase font-sans ${isActive ? "text-white" : "text-white/70"}`}>
                        {mod.name}
                      </h3>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <ChevronRight className={`w-4 h-4 transition-transform duration-200 ${isActive ? "rotate-90 text-[#3daeff]" : "text-white/30"}`} />
                    </div>
                  </div>

                  <p className={`text-[13px] sm:text-[13.5px] leading-[1.65] font-normal font-sans ${isActive ? "text-white/80" : "text-white/50"}`}>
                    {mod.fullDesc}
                  </p>
            ...
            <div className="w-full rounded-2xl border border-white/[0.08] bg-[#02050c] p-6 sm:p-8 relative overflow-hidden">
              ...
              <div className="relative w-full aspect-[16/10] rounded-xl overflow-hidden bg-[#04070f] border border-white/[0.06] flex items-center justify-center p-6 group">
                ...
                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center text-center">
                  ...
                  <div className="absolute top-3 left-3 flex items-center gap-1.5 bg-[#010409]/90 border border-white/[0.06] px-2 py-1 rounded text-[9px] font-mono text-white/70 tracking-wider">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#3daeff]"></span>
                    <span>DCIM FEED: 100% ONLINE</span>
                  </div>

                  <div className="absolute bottom-3 right-3 bg-[#010409]/90 border border-white/[0.06] px-2 py-1 rounded text-[9px] font-mono text-white/70 tracking-wider">
              ...
              <div className="mt-6 pt-4 border-t border-white/[0.05] flex items-center justify-between text-[11px] font-mono text-white/40">
                ...
                <span className="text-[#3daeff]">Step {activeIdx + 1} of 8</span>
              </div>
            </div>
          </div>
